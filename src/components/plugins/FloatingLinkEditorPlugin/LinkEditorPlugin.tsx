...
/**
 * This plugin is dispatchable as a Lexical command.  It will render the link editor
 * modal dialog.
 */
export const LinkEditorPlugin: React.FC<{
  ...
  return (
    <Dialog open={open} onOpenChange={onEditDialogCloseHandler}>
      <DialogContent container={anchorElem}>
        <Form {...form}>
